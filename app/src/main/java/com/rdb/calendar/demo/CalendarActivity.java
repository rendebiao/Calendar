...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarView.setSelectMode(CalendarSelectMode.WEEK);
        ...
        calendarView.setSelectListener(new CalendarSelectListener() {
            ...
            protected void onDaySelected(long dayTime) {
                ...
                Toast.makeText(MainActivity.this,"onDaySelected:" + dateFormat.format(new Date(dayTime)),Toast.LENGTH_SHORT).show();
            }

            @Override
            protected void onWeekSelected(long weekTime) {
                super.onWeekSelected(weekTime);
                Toast.makeText(MainActivity.this,"onWeekSelected:" + dateFormat.format(new Date(weekTime)),Toast.LENGTH_SHORT).show();
            }

            @Override
            protected void onRangeSelected(long startDay, long endDay) {
                super.onRangeSelected(startDay, endDay);
                Toast.makeText(MainActivity.this,"onRangeSelected:" + dateFormat.format(new Date(startDay))+ "->" +dateFormat.format(new Date(endDay)),Toast.LENGTH_SHORT).show();
            }
        });
    }
}
